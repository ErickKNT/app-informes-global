...
export const AttendanceFormModal: React.FC<AttendanceFormModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-50 overflow-y-auto p-3 sm:p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-200"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div className="flex min-h-full items-start sm:items-center justify-center py-2 sm:py-6 pointer-events-none">
        <div className="w-full max-w-lg bg-surface-container-lowest rounded-3xl border border-surface-container-high shadow-2xl flex flex-col max-h-[calc(100dvh-2.5rem)] min-h-0 overflow-hidden pointer-events-auto">
          {/* Modal Header Fijo */}
