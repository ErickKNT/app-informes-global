  ...
  return (
    ...
    >
      <div className="flex min-h-full items-start sm:items-center justify-center py-2 sm:py-6 pointer-events-none">
        <div
          className={cn(
            'bg-surface-container-lowest rounded-2xl border border-surface-container-high shadow-2xl pointer-events-auto',
            'w-full max-w-lg max-h-[calc(100dvh-2.5rem)] flex flex-col min-h-0 overflow-hidden'
          )}
        >
          {/* Header del Modal */}
          ...
          <div className="p-4 sm:p-6 overflow-y-auto flex-1 min-h-0 overscroll-contain">
            <ReportSubmissionForm
              ...
              hideTitle={true}
              className="border-0 p-0 shadow-none gap-4"
            />
          </div>
        </div>
      </div>
